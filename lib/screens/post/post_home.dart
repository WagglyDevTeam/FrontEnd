    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child:
            ...
            Row(
              children: [
                Obx(() => Text(_postDetailX.userCollegeData.value.collegeTypeName, style: CommonText.TitleS)),
                SizedBox(width: 6.w),
            ...
            Obx(() => PostCard(
                  ...
                  postName: _postDetailX.userCollegeData.value.collegeTypeName,
            ...
            SizedBox(
              ...
              child: Obx(() => PostDifferentList(widgetList: [
                    for (var i = 0; i < _postDetailX.otherCollegeData.value.length; i++)
                      Row(
                        children: [
                          Obx(() => PostCard(
                                postList: _postDetailX.otherCollegeData.value[i].posts,
                                postName: _postDetailX.otherCollegeData.value[i].collegeTypeName,
                                collegeId: _postDetailX.otherCollegeData.value[i].collegeType,
                                on: off,
                                page: page,
                              )),
                          SizedBox(width: 20.w)
    ...
    return GestureDetector(
        onTap: () {
          signInController.checkLoggedIn().value == false
              ...
              //   });
              : Get.toNamed("/postCollege/param?collegeId=$collegeId&collegeName=$postName");
        },
        child: Container(
          height: 220.h,
          width: 250.w,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 70.h,
                padding: EdgeInsets.only(left: 20.w, right: 15.w, top: 5.h, bottom: 5.h),
                decoration: BoxDecoration(
