...
class _DetailHiddenBtnState extends State<DetailHiddenBtn> {
  ...
  Widget build(BuildContext context) {
    double modalHeight =
        _postDetailX.postDetail.value.authorId == loginUserId ? 150.h : 120.h;
    String title = '글 메뉴';
    void postDelete() {
    ...
    PostModal modalOn = PostModal(
        context: context,
        contents: buttons(context, widget.pageContext, loginUserId),
        height: modalHeight,
        title: title);
      ...
      children: [
        ...
        if (_postDetailX.postDetail.value.authorId == loginUserId)
          ModalButton(
              ...
              event: () {
                Get.toNamed(
                    "/editPage/param?postId=${_postDetailX.postDetail.value.postId ?? 0}&collegeName=${Get.parameters['collegeName']}&collegeId=${Get.parameters['collegeId']}");
              }),
        if (_postDetailX.postDetail.value.authorId != loginUserId)
          ModalButton(
              title: '신고하기',
  ...
  Widget build(BuildContext context) {
    ...
    onLikedByMe() {
      _postDetailX.updateDetailBoardLike(
        isLikedByMe:
            _postDetailX.postDetail.value.isLikedByMe == true ? false : true,
                                                                ...
                                                                children: [
                                                                  GestureDetector(
                                                                    onTap: () =>
                                                                      ...
                                                                      showImageViewer(
                                                                        context,
                                                                        Image.network(_postDetailX.postDetail.value.postImages?[imgIndex])
                                                                            .image,
                                                                        swipeDismissible:
                                                                            true,
                                                                        doubleTapZoomable:
...
class PostDetailTextarea extends StatefulWidget {
  PostDetailTextarea({Key? key, required this.scrollController})
      : super(key: key);
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomTextFormField(
                          ...
                          controller: _comment,
                          hint: _postDetailX.reCommentInputOn.value &&
                                  _isChecked == false
                              ? "대댓글 작성하기"
                              : "",
                        ),
