...
// import 'package:waggly/screens/image_view.dart';
...
//               ),
//             ),
//             Container(color: Colors.lightBlue, child: ImageView()),
//             Padding(
//               padding: const EdgeInsets.only(left: 20.0, right: 20.0),
//               child: Container(
//                 color: Colors.red,
...
// //
// //   ImageThumbnailWidget({required this.images});
// //
// //   @override
// //   Widget build(BuildContext context) {
// //     if (images.isEmpty) {
...
// //   const ImageThumbnailWidget({Key? key}) : super(key: key);
// //
// //   @override
...
// //   Widget wid = ImageWidget(imageController: Get.put(ImageController()));
// //
// //   @override
// //   Widget build(BuildContext context) {
// //     return wid;
...
// //         itemBuilder: (BuildContext context, int index) {
// //           return Image.file(File(imageController.images![index].path),
// //               fit: BoxFit.fill);
// //         },
// //       ),
// //     );
