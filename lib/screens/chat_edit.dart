      ...
      children: [
        InkWell(
          ...
          child: Container(
            ...
            child: SvgPicture.asset('assets/icons/unions.svg',color: Colors.white,width: 13.w,height: 12.h,)
          ),
        )
        ,
        SizedBox(width: 12.w),
        InkWell(
          ...
          child: Container(
            ...
            height: 24.h,
            padding: EdgeInsets.all(0),
            child: SvgPicture.asset('assets/icons/groupIcon.svg',color: Colors.grey,width: 24.w,height: 12.h,)
          ),
        ),
      ],
    );
